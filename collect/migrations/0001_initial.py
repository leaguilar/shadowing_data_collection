    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zone', models.CharField(choices=[('NUROPE', 'Nurse station open'), ('NURSTA', 'Nurse station'), ('NEUOFF', 'Neuro offices'), ('COCPIT', 'Cockpit'), ('OFFSPA', 'Office spaces'), ('CORRFT', 'Corridor Fast Track'), ('CORR01', 'Corridor 1'), ('CORR02', 'Corridor 2'), ('CORR03', 'Corridor 3'), ('CORR04', 'Corridor 4'), ('CORR05', 'Corridor 5'), ('CORR06', 'Corridor 6'), ('CORR07', 'Corridor 7')], default=None, max_length=6)),
